...
const Controls: React.FC<ControlsProps> = ({
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 w-full px-4 max-w-xl z-[70]">
      
      {/* Tool & Session Management */}
      <div className="flex gap-2 w-full">
        <div className="flex bg-zinc-900/95 backdrop-blur-md rounded-xl p-1 border border-zinc-800 flex-1 shadow-xl">
            <button 
      ...
      <div className="flex items-center gap-4 bg-zinc-900/95 backdrop-blur-md px-6 py-4 rounded-2xl border border-zinc-800 shadow-2xl w-full">
        ...
        <div className="flex-1 px-2 flex items-center gap-3 relative">
            <span className="absolute -top-6 left-0 text-[8px] font-black text-zinc-600 tracking-widest uppercase">
                {tool === 'text' ? 'Size' : 'Brush'}: {brushSize}px
            </span>
            <input 
